...
ROLES_REQUIREMENTS_FILE="$ROOT_DIR/roles/role_requirements.yml"
...
[[ ! -f "$ROLES_REQUIREMENTS_FILE" ]]  && msg_exit "roles_requirements '$ROLES_REQUIREMENTS_FILE' does not exist or permission issue.\nPlease check and rerun."
